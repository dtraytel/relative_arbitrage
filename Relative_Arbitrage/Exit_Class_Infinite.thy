...
subsection \<open>The martingale clauses hold for the filtration of \<open>X\<close> alone\<close>
...
text \<open>The class is a set of laws of the pair \<open>(X, \<langle>X\<rangle>)\<close>, and the martingale
  ...
  a martingale in the paper's sense.  The general step first: a martingale stays
  one along any coarser filtration it is still adapted to.\<close>
